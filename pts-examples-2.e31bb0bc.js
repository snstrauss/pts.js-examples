...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"lib/pts.js":[function(require,module,exports) {
var define;
...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') exports["Pts"] = factory();else root["Pts"] = factory();
})(window, function () {
  return (
    /******/
    function (modules) {
    ...
    /******/
    {
      ...
      function srcCanvasTs(module, exports, __webpack_require__) {
        ...
        var CanvasSpace =
        /*#__PURE__*/
        function (_Space_1$MultiTouchSp) {
      ...
      function srcColorTs(module, exports, __webpack_require__) {
        ...
        function (_Pt_1$Pt) {
          ...
          function Color() {
            ...
            _this6 = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Color)).call.apply(_getPrototypeOf2, [this].concat(args)));
            _this6._mode = "rgb";
            _this6._isNorm = false;
            return _this6;
          }
      ...
      function srcCreateTs(module, exports, __webpack_require__) {
        ...
        function (_Pt_1$Pt2) {
          ...
          function Noise() {
            ...
            _this7 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(Noise)).call.apply(_getPrototypeOf3, [this].concat(args)));
            _this7.perm = [];
            _this7._n = new Pt_1.Pt(0.01, 0.01);
            _this7.perm = __noise_permTable.concat(__noise_permTable);
            return _this7;
          }
          ...
          _createClass(Noise, [{
            ...
            value: function initNoise() {
              ...
              this._n = _construct(Pt_1.Pt, args);
              return this;
            }
          }, {
            key: "step",
        ...
        function (_Pt_1$Group) {
          ...
          function Delaunay() {
            ...
            _this8 = _possibleConstructorReturn(this, _getPrototypeOf(Delaunay).apply(this, arguments));
            _this8._mesh = [];
            return _this8;
          }
          ...
          _createClass(Delaunay, [{
            ...
            value: function delaunay() {
              ...
              for (var _i3 = 0, _len6 = opened.length; _i3 < _len6; _i3++) {
                var o = opened[_i3];
      ...
      function srcDomTs(module, exports, __webpack_require__) {
        ...
        var DOMSpace =
        /*#__PURE__*/
        function (_Space_1$MultiTouchSp2) {
          _inherits(DOMSpace, _Space_1$MultiTouchSp2);
          ...
          function DOMSpace(elem, callback) {
            ...
            _this10 = _possibleConstructorReturn(this, _getPrototypeOf(DOMSpace).call(this));
            _this10.id = "domspace";
            _this10._autoResize = true;
            _this10._bgcolor = "#e1e9f0";
            _this10._css = {};
            var _selector = null;
            var _existed = false;
            _this10.id = "pts";
            ...
            if (elem instanceof Element) {
              _selector = elem;
              _this10.id = "pts_existing_space";
            } else {
              _selector = document.querySelector(elem);
              _existed = true;
              _this10.id = elem.substr(1);
            }

            if (!_selector) {
              _this10._container = DOMSpace.createElement("div", "pts_container");
              _this10._canvas = DOMSpace.createElement("div", "pts_element");

              _this10._container.appendChild(_this10._canvas);

              document.body.appendChild(_this10._container);
              _existed = false;
            } else {
              _this10._canvas = _selector;
              _this10._container = _selector.parentElement;
            }

            setTimeout(_this10._ready.bind(_assertThisInitialized(_this10), callback), 50);
            return _this10;
          }
        ...
        var HTMLForm =
        /*#__PURE__*/
        function (_Form_1$VisualForm2) {
          _inherits(HTMLForm, _Form_1$VisualForm2);
          ...
          function HTMLForm(space) {
            ...
            _this11 = _possibleConstructorReturn(this, _getPrototypeOf(HTMLForm).call(this));
            _this11._style = {
              "filled": true,
              "stroked": true,
              "background": "#f03",
            ...
            _this11._space = space;

            _this11._space.add({
              start: function start() {
                _this11._ctx.group = _this11._space.element;
                _this11._ctx.groupID = "pts_dom_" + HTMLForm.groupID++;
                _this11._ctx.style = Object.assign({}, _this11._style);
                _this11._ready = true;
              }
            });
      ...
      function srcFormTs(module, exports, __webpack_require__) {
        ...
        function (_Form) {
          ...
          function VisualForm() {
            ...
            _this12 = _possibleConstructorReturn(this, _getPrototypeOf(VisualForm).apply(this, arguments));
            _this12._filled = true;
            _this12._stroked = true;
            _this12._font = new Font(14, "sans-serif");
            return _this12;
          }
          ...
          _createClass(VisualForm, [{
            ...
            value: function _multiple(groups, shape) {
              ...
              for (var _len7 = arguments.length, rest = new Array(_len7 > 2 ? _len7 - 2 : 0), _key5 = 2; _key5 < _len7; _key5++) {
          ...
          _createClass(Vec, null, [{
            ...
            value: function add(a, b) {
              if (typeof b == "number") {
                ...
                for (var _i4 = 0, _len8 = a.length; _i4 < _len8; _i4++) {
                  a[_i4] += b[_i4] || 0;
                }
              }
            ...
            value: function subtract(a, b) {
              if (typeof b == "number") {
                ...
                for (var _i5 = 0, _len9 = a.length; _i5 < _len9; _i5++) {
                  a[_i5] -= b[_i5] || 0;
                }
              }
            ...
            value: function multiply(a, b) {
              if (typeof b == "number") {
                ...
                for (var _i6 = 0, _len10 = a.length; _i6 < _len10; _i6++) {
                  a[_i6] *= b[_i6];
                }
              }
            ...
            value: function divide(a, b) {
              if (typeof b == "number") {
                ...
                for (var _i7 = 0, _len11 = a.length; _i7 < _len11; _i7++) {
                  a[_i7] /= b[_i7];
                }
              }
        ...
        function () {
          ...
          _createClass(Shaping, null, [{
            ...
            value: function step(fn, steps, t, c) {
              ...
              for (var _len12 = arguments.length, args = new Array(_len12 > 4 ? _len12 - 4 : 0), _key6 = 4; _key6 < _len12; _key6++) {
      ...
      function srcOpTs(module, exports, __webpack_require__) {
        ...
        var _errorOutofBound = function _errorOutofBound(obj) {
          ...
          return Util_1.Util.warn("Index ".concat(param, " is out of bound in Group"), obj);
        };
        ...
        function () {
          ...
          _createClass(Polygon, null, [{
            ...
            value: function hasIntersectPolygon(poly1, poly2) {
              ...
              for (var _i8 = 0, len = b1.length; _i8 < len; _i8++) {
                var d = info.normal.dot(b1[_i8].$subtract(c2));
          ...
          _createClass(Curve, null, [{
            ...
            value: function catmullRom(pts) {
              ...
              while (k < pts.length - 2) {
                ...
                if (cp.length > 0) {
                  for (var _i9 = 0; _i9 <= steps; _i9++) {
                    ps.push(Curve.catmullRomStep(ts[_i9], cp));
                  }
            ...
            value: function cardinal(pts) {
              ...
              while (k < pts.length - 2) {
                ...
                if (cp.length > 0) {
                  for (var _i10 = 0; _i10 <= steps; _i10++) {
                    ps.push(Curve.cardinalStep(ts[_i10], cp, tension));
                  }
              ...
              while (k < pts.length - 3) {
                ...
                if (c.length > 0) {
                  if (tension !== 1) {
                    ...
                    for (var _i11 = 0; _i11 <= steps; _i11++) {
                      ps.push(Curve.bsplineStep(ts[_i11], c));
                    }
                  }
      ...
      function srcPhysicsTs(module, exports, __webpack_require__) {
        ...
        function (_Pt_1$Pt3) {
          ...
          function Particle() {
            ...
            _this13 = _possibleConstructorReturn(this, (_getPrototypeOf4 = _getPrototypeOf(Particle)).call.apply(_getPrototypeOf4, [this].concat(args)));
            _this13._mass = 1;
            _this13._radius = 0;
            _this13._force = new Pt_1.Pt();
            _this13._prev = new Pt_1.Pt();
            _this13._lock = false;
            _this13._prev = _this13.clone();
            return _this13;
          }
          ...
          _createClass(Particle, [{
            ...
            value: function hit() {
              ...
              this._prev.subtract(_construct(Pt_1.Pt, args).$divide(Math.sqrt(this._mass)));
        ...
        var Body =
        /*#__PURE__*/
        function (_Pt_1$Group2) {
          _inherits(Body, _Pt_1$Group2);
          ...
          function Body() {
            ...
            _this14 = _possibleConstructorReturn(this, _getPrototypeOf(Body).call(this));
            _this14._cs = [];
            _this14._stiff = 1;
            _this14._locks = {};
            _this14._mass = 1;
        ...
        function () {
          ...
          _createClass(Sound, [{
            ...
            value: function from(node, ctx) {
              ...
              var stream = arguments.length > 3 ? arguments[3] : undefined;
      ...
      function srcPtTs(module, exports, __webpack_require__) {
        ...
        function (_Float32Array) {
          ...
          function Pt() {
            ...
            if (args.length === 1 && typeof args[0] == "number") {
              _this16 = _possibleConstructorReturn(this, _getPrototypeOf(Pt).call(this, args[0]));
            } else {
              _this16 = _possibleConstructorReturn(this, _getPrototypeOf(Pt).call(this, args.length > 0 ? Util_1.Util.getArgs(args) : [0, 0]));
            }
          ...
          _createClass(Pt, [{
            ...
            value: function op(fn) {
              var self = this;
              return function () {
                for (var _len17 = arguments.length, params = new Array(_len17), _key11 = 0; _key11 < _len17; _key11++) {
            ...
            value: function scale(_scale2, anchor) {
              Num_1.Geom.scale(this, _scale2, anchor || Pt.make(this.length, 0));
              return this;
            }
          }, {
            key: "rotate2D",
        ...
        function (_Array) {
          ...
          function Group() {
            ...
            return _possibleConstructorReturn(this, (_getPrototypeOf5 = _getPrototypeOf(Group)).call.apply(_getPrototypeOf5, [this].concat(args)));
          }
          ...
          _createClass(Group, [{
            ...
            value: function op(fn) {
              var self = this;
              return function () {
                for (var _len29 = arguments.length, params = new Array(_len29), _key23 = 0; _key23 < _len29; _key23++) {
            ...
            key: "scale",
            value: function scale(_scale3, anchor) {
              for (var i = 0, len = this.length; i < len; i++) {
                Num_1.Geom.scale(this[i], _scale3, anchor || this[0]);
              }
            ...
            value: function forEachPt(ptFn) {
              if (!this[0][ptFn]) {
                Util_1.Util.warn("".concat(ptFn, " is not a function of Pt"));
                return this;
              }

              for (var _len31 = arguments.length, args = new Array(_len31 > 1 ? _len31 - 1 : 0), _key25 = 1; _key25 < _len31; _key25++) {
        ...
        function (_Group) {
          ...
          function Bound() {
            ...
            _this17 = _possibleConstructorReturn(this, (_getPrototypeOf6 = _getPrototypeOf(Bound)).call.apply(_getPrototypeOf6, [this].concat(args)));
            _this17._center = new Pt();
            _this17._size = new Pt();
            _this17._topLeft = new Pt();
            _this17._bottomRight = new Pt();
            _this17._inited = false;
      ...
      function srcSpaceTs(module, exports, __webpack_require__) {
        ...
        function (_Space) {
          ...
          function MultiTouchSpace() {
            ...
            _this18 = _possibleConstructorReturn(this, _getPrototypeOf(MultiTouchSpace).apply(this, arguments));
            _this18._pressed = false;
            _this18._dragged = false;
            _this18._hasMouse = false;
            _this18._hasTouch = false;
            return _this18;
          }
          ...
          _createClass(MultiTouchSpace, [{
            ...
            value: function _mouseAction(type, evt) {
              ...
              if (evt instanceof MouseEvent) {
                ...
                for (var _k2 in this.players) {
                  if (this.players.hasOwnProperty(_k2)) {
                    var _v = this.players[_k2];
      ...
      function srcSvgTs(module, exports, __webpack_require__) {
        ...
        function (_Dom_1$DOMSpace) {
          ...
          function SVGSpace(elem, callback) {
            ...
            _this19 = _possibleConstructorReturn(this, _getPrototypeOf(SVGSpace).call(this, elem, callback));
            _this19.id = "svgspace";
            _this19._bgcolor = "#999";

            if (_this19._canvas.nodeName.toLowerCase() != "svg") {
              var s = SVGSpace.svgElement(_this19._canvas, "svg", "".concat(_this19.id, "_svg"));
              _this19._container = _this19._canvas;
              _this19._canvas = s;
            }
        ...
        var SVGForm =
        /*#__PURE__*/
        function (_Form_1$VisualForm3) {
          _inherits(SVGForm, _Form_1$VisualForm3);
          ...
          function SVGForm(space) {
            ...
            _this20 = _possibleConstructorReturn(this, _getPrototypeOf(SVGForm).call(this));
            _this20._style = {
              "filled": true,
              "stroked": true,
              "fill": "#f03",
            ...
            _this20._space = space;

            _this20._space.add({
              start: function start() {
                _this20._ctx.group = _this20._space.element;
                _this20._ctx.groupID = "pts_svg_" + SVGForm.groupID++;
                _this20._ctx.style = Object.assign({}, _this20._style);
                _this20._ready = true;
              }
            });
      ...
      function srcUITs(module, exports, __webpack_require__) {
        ...
        function (_UI) {
          ...
          function UIButton(group, shape) {
            ...
            _this21 = _possibleConstructorReturn(this, _getPrototypeOf(UIButton).call(this, group, shape, states, id));
            _this21._hoverID = -1;
            if (states.hover === undefined) _this21._states['hover'] = false;
            if (states.clicks === undefined) _this21._states['clicks'] = 0;
            var UA = exports.UIPointerActions;

            _this21.on(UA.up, function (target, pt, type, evt) {
              _this21.state('clicks', _this21._states.clicks + 1);
            });

            _this21.on(UA.move, function (target, pt, type, evt) {
              var hover = _this21._within(pt);

              if (hover && !_this21._states.hover) {
                _this21.state('hover', true);

                UI._trigger(_this21._actions[UA.enter], _assertThisInitialized(_this21), pt, UA.enter, evt);

                var _capID = _this21.hold(UA.move);

                _this21._hoverID = _this21.on(UA.move, function (t, p) {
                  if (!_this21._within(p) && !_this21.state('dragging')) {
                    _this21.state('hover', false);

                    UI._trigger(_this21._actions[UA.leave], _assertThisInitialized(_this21), pt, UA.leave, evt);

                    _this21.off(UA.move, _this21._hoverID);

                    _this21.unhold(_capID);
                  }
                });
              }
            });
        ...
        function (_UIButton) {
          ...
          function UIDragger(group, shape) {
            ...
            _this22 = _possibleConstructorReturn(this, _getPrototypeOf(UIDragger).call(this, group, shape, states, id));
            _this22._draggingID = -1;
            _this22._moveHoldID = -1;
            _this22._dropHoldID = -1;
            _this22._upHoldID = -1;
            if (states.dragging === undefined) _this22._states['dragging'] = false;
            if (states.moved === undefined) _this22._states['moved'] = false;
            if (states.offset === undefined) _this22._states['offset'] = new Pt_1.Pt();
            var UA = exports.UIPointerActions;

            _this22.on(UA.down, function (target, pt, type, evt) {
              if (_this22._moveHoldID === -1) {
                _this22.state('dragging', true);

                _this22.state('offset', new Pt_1.Pt(pt).subtract(target.group[0]));

                _this22._moveHoldID = _this22.hold(UA.move);
              }

              if (_this22._dropHoldID === -1) {
                _this22._dropHoldID = _this22.hold(UA.drop);
              }

              if (_this22._upHoldID === -1) {
                _this22._upHoldID = _this22.hold(UA.up);
              }

              if (_this22._draggingID === -1) {
                _this22._draggingID = _this22.on(UA.move, function (t, p) {
                  if (_this22.state('dragging')) {
                    UI._trigger(_this22._actions[UA.uidrag], t, p, UA.uidrag, evt);

                    _this22.state('moved', true);
                  }
                });
              }
            });
            ...
            var endDrag = function endDrag(target, pt, type, evt) {
              _this22.state('dragging', false);

              _this22.off(UA.move, _this22._draggingID);

              _this22._draggingID = -1;

              _this22.unhold(_this22._moveHoldID);

              _this22._moveHoldID = -1;

              _this22.unhold(_this22._dropHoldID);

              _this22._dropHoldID = -1;

              _this22.unhold(_this22._upHoldID);

              _this22._upHoldID = -1;

              if (_this22.state('moved')) {
                UI._trigger(_this22._actions[UA.uidrop], target, pt, UA.uidrop, evt);

                _this22.state('moved', false);
              }
            };

            _this22.on(UA.drop, endDrag);

            _this22.on(UA.up, endDrag);

            _this22.on(UA.out, endDrag);
      ...
      /***/
      function src_libTs(module, exports, __webpack_require__) {
        "use strict";
        ...
        exports.namespace = function (scope) {
        ...
        exports.quickStart = function (id) {
          var bg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "#9ab";
          var s = window;
          exports.namespace(s);
          s.space = new _Canvas.CanvasSpace(id).setup({
            bgcolor: bg,
            resize: true,
            retina: true
          });
          ...
          return function () {
            var animate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
            var start = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            var action = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            var resize = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
            s.space.add({
              start: start,
              animate: animate,
              resize: resize,
...
},{}],"examples/1_basic.js":[function(require,module,exports) {
"use strict";
...
function basic() {
  space.add({
    animate: function animate(t, ft) {
      form.point(space.pointer, 10, 'circle');
    }
  });
  space.bindMouse().bindTouch().play();
}
},{}],"examples/2_squeare.js":[function(require,module,exports) {
"use strict";
...
},{}],"examples/index.js":[function(require,module,exports) {
"use strict";
...
var _basic = _interopRequireDefault(require("./1_basic"));

var _squeare = _interopRequireDefault(require("./2_squeare"));
...
var examples = [{
  ...
  title: 'square',
  play: _squeare.default
}];
var _default = examples;
exports.default = _default;
},{"./1_basic":"examples/1_basic.js","./2_squeare":"examples/2_squeare.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _pts = require("./lib/pts");

var _examples = _interopRequireDefault(require("./examples"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.space = new _pts.CanvasSpace('#canvasContainer');
window.form = space.getForm();
var nav = document.querySelector('.container nav');

_examples.default.forEach(function (example, i) {
  var button = document.createElement('button');
  button.innerText = example.title;
  button.setAttribute('onclick', "playExample(".concat(i, ")"));
...
window.playExample = function playExample(exampleIdx) {
  ...
  _examples.default[exampleIdx].play();
};

function colorCorrectNavButton(selected) {
  debugger;
  Array.from(document.querySelectorAll('.nav-button')).forEach(function (button, i) {
    debugger;
...
},{"./lib/pts":"lib/pts.js","./examples":"examples/index.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/pts-examples-2.e31bb0bc.js.map